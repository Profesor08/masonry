...
const gridTemplateColumns = [
  ...
  "1fr 1fr 200px 1fr auto",
  "auto 1fr minmax(150px, 200px) 1fr auto",
];

export const App = () => {
  const gridRef = useRef<HTMLDivElement>(null);
  const [columns, setColumns] = useState(gridTemplateColumns[0]);
  ...
  return (
    <>
      <div className="flex justify-between h-9 items-center space-x-1 border bg-background p-1 shadow-sm rounded-none border-b border-none px-2 lg:px-4">
        <div className="flex cursor-default select-none items-center rounded-sm px-3 py-1 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground font-bold">
          Masonry
        </div>
